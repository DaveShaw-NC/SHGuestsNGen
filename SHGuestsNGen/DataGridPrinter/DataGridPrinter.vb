        ...
        Public ReadOnly Property SourceDataTable As DataTable
            Get
                If (_DataGrid IsNot Nothing) Then
                    Return CType(_DataGrid.DataSource, System.Data.DataTable)
                ElseIf (_dataGridView IsNot Nothing) Then
                    Return CType(_dataGridView.DataSource, System.Data.DataTable)
                Else
        ...
        Private Sub _GridPrintDocument_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles _GridPrintDocument.PrintPage
            ...
            If _CurrentPageDown = 1 And _CurrentPageAcross = 1 Then
                ...
                If (_dataGridView IsNot Nothing) Then
                    If _dataGridView.DataSource Is Nothing Then
                        '\\ Nothing in the grid to print
                        Exit Sub
                    End If
                End If
            ...
            For nextLine = _CurrentPrintGridLine To Min((_CurrentPrintGridLine + RowsPerPage(_PrintFont, e.Graphics)), Me.TotalRows)
...
#Region "Private methods"
        ...
        Private Sub PrintGridLine(ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal RowNumber As Integer)
            ...
            Try
                ...
                Dim _cellAlignment As CellTextHorizontalAlignment = CellTextHorizontalAlignment.LeftAlign
                Dim _vertAlignment As CellTextVerticalAlignment = CellTextVerticalAlignment.BottomAlign
                    ...
                    If _ColumnBounds(nColumn).Page = _CurrentPageAcross Then
                        ...
                        If rcCell.Width > 0 Then
                            ...
                            Try
                                ...
                                ElseIf (_dataGridView IsNot Nothing) Then
                                    ' Use formatted data in DataGridView not underlying datasource fields
                                    Dim dgvc As DataGridViewCell = _dataGridView.Rows(RowNumber - 1).Cells(MappedColumnToBaseColumn(nColumn))
                                    Dim dvgcol As DataGridViewColumn = _dataGridView.Columns(nColumn)
                                    Columntext = dgvc.FormattedValue.ToString()
                                    Select Case dvgcol.DefaultCellStyle.Alignment
                                        Case DataGridViewContentAlignment.BottomCenter
                                            _cellAlignment = CellTextHorizontalAlignment.CentreAlign
                                        Case DataGridViewContentAlignment.BottomLeft
                                            _cellAlignment = CellTextHorizontalAlignment.LeftAlign
                                        Case DataGridViewContentAlignment.BottomRight
                                            _cellAlignment = CellTextHorizontalAlignment.RightAlign
                                    End Select
                                End If
                            Catch
                            End Try
                            Call DrawCellString(Columntext, _cellAlignment, _vertAlignment, rcCell, True, e.Graphics, _PrintFont, RowBrush)
                        End If
                    End If
                Next
        ...
        Private Function GetRowItems(ByVal rowNumber As Integer) As Object()

            If (_DataGrid IsNot Nothing) Then
                If TypeOf _DataGrid.DataSource Is DataTable Then
                    Return CType(_DataGrid.DataSource, System.Data.DataTable).DefaultView.Item(rowNumber - 1).Row.ItemArray
                ElseIf TypeOf _DataGrid.DataSource Is DataSet Then
                    Return CType(_DataGrid.DataSource, System.Data.DataSet).Tables(_DataGrid.DataMember).DefaultView.Item(rowNumber - 1).Row.ItemArray
                ElseIf TypeOf _DataGrid.DataSource Is DataView Then
                    Return CType(_DataGrid.DataSource, System.Data.DataView).Table.DefaultView.Item(rowNumber - 1).Row.ItemArray
                Else
                    Throw New ArgumentException("Data Grid has unknown backing data source")
                End If
            Else
                If TypeOf _dataGridView.DataSource Is DataTable Then
                    Return CType(_dataGridView.DataSource, System.Data.DataTable).DefaultView.Item(rowNumber - 1).Row.ItemArray
                ElseIf TypeOf _dataGridView.DataSource Is DataSet Then
                    Return CType(_dataGridView.DataSource, System.Data.DataSet).Tables(_DataGrid.DataMember).DefaultView.Item(rowNumber - 1).Row.ItemArray
                ElseIf TypeOf _dataGridView.DataSource Is DataView Then
                    Return CType(_dataGridView.DataSource, System.Data.DataView).Table.DefaultView.Item(rowNumber - 1).Row.ItemArray
                Else
        ...
        Private Sub PrintGridHeaderLine(ByVal e As System.Drawing.Printing.PrintPageEventArgs)
            ...
            For nColumn = 0 To GridColumnCount() - 1
                If _ColumnBounds(nColumn).Page = _CurrentPageAcross Then
                    Dim rcCell As New Rectangle(CInt(_ColumnBounds(nColumn).Left), CInt(Top), CInt(_ColumnBounds(nColumn).Width), CInt(Bottom - Top))
                    If rcCell.Width > 0 Then
                        Call DrawCellString(GetColumnHeadingText(nColumn), CellTextHorizontalAlignment.LeftAlign, CellTextVerticalAlignment.BottomAlign, rcCell, True, e.Graphics, _PrintFont, _ColumnHeaderBrush)
                    End If
                End If
            Next
        End Sub
        ...
        Public Sub DrawCellString(ByVal s As String,
                                    ByVal HorizontalAlignment As CellTextHorizontalAlignment,
                                    ByVal VerticalAlignment As CellTextVerticalAlignment,
                                    ByVal BoundingRect As Rectangle,
                                    ByVal DrawRectangle As Boolean,
                                    ByVal Target As Graphics,
            ...
            Select Case HorizontalAlignment
                Case CellTextHorizontalAlignment.LeftAlign
                    _Textlayout.Alignment = StringAlignment.Near
                Case CellTextHorizontalAlignment.RightAlign
                    _Textlayout.Alignment = StringAlignment.Far
                Case CellTextHorizontalAlignment.CentreAlign
        ...
        Private Function GridColumnCount() As Integer
            ...
            If _GridColumnCount = 0 Then
                If (_DataGrid IsNot Nothing) Then
                    ...
                    End If
                ElseIf (_dataGridView IsNot Nothing) Then
                    _GridColumnCount = _dataGridView.ColumnCount
                End If
            End If
        ...
        Private Function GridRowCount() As Integer
            ...
            If _GridRowCount = 0 Then
                If (_DataGrid IsNot Nothing) Then
                    ...
                    End If
                ElseIf (_dataGridView IsNot Nothing) Then
                    _GridRowCount = _dataGridView.RowCount
                End If
            End If
        ...
        Private Function GetColumnHeadingText(ByVal Column As Integer) As String
            ...
            If (_DataGrid IsNot Nothing) Then
                ...
                End If
            ElseIf (_dataGridView IsNot Nothing) Then
                Return _dataGridView.Columns(Column).HeaderText
            Else
                Return String.Empty
            End If
            Return String.Empty
